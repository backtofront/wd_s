 ...
 */
function back_to_front_starter_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'back_to_front_starter_remove_default_customizer_sections', 15 );
 ...
 * @author WDS
 */
function back_to_front_starter_include_custom_controls() {
...
add_action( 'customize_register', 'back_to_front_starter_include_custom_controls', -999 );
 ...
 * @author WDS
 */
function back_to_front_starter_customize_scripts() {
	wp_enqueue_script( 'back_to_front_starter-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array( 'jquery', 'customize-preview' ), '1.0.0', true );
}
add_action( 'customize_preview_init', 'back_to_front_starter_customize_scripts' );
 ...
 */
function back_to_front_starter_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = array(
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'back_to_front_starter_copyright_text' => '.site-info',
	);
...
add_action( 'customize_register', 'back_to_front_starter_selective_refresh_support' );
 ...
 */
function back_to_front_starter_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'back_to_front_starter_live_preview_support', 999 );
