 ...
 */
gulp.task("clean:styles", () => del(["style.css", "style.min.css"]));
...
gulp.task("postcss", ["clean:styles"], () =>
	gulp
		.src("assets/sass/*.scss", paths.css)
 ...
 */
gulp.task("clean:pot", () => del(["languages/back_to_front_starter.pot"]));
...
gulp.task("wp-pot", ["clean:pot"], () =>
	gulp
		...
		.pipe(
			wpPot({
				domain: "back_to_front_starter",
				package: "back_to_front_starter"
			})
		)
		.pipe(gulp.dest("languages/back_to_front_starter.pot"))
);
...
gulp.task("sassdoc", function() {
	...
	return gulp.src("assets/sass/**/*.scss").pipe(sassdoc(options));
});
